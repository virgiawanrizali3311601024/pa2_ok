...
function download_kontrak_p_kibf($id_aset)
	...
	public function simpan_a($data_a)
	{
		
		$query = $this->db->insert("kib_a", $data_a);
...
*/
    ...
    function get_kode_asset_A_nama()
    {
       $this->db->select('nama_aset');
		$this->db->from('sub_sub_kelompok');
		$this->db->distinct();
    ...
    {
      $this->db->select(array('kode_lokasi'));
      $this->db->from('skpd');
	...
	function get_kode_asset_B()
    {
    	/*$this->db->select('nama_aset, kode_aset');
		$this->db->from('sub_sub_kelompok');
		$this->db->distinct();
		$this->db->order_by('kode_aset', 'asc');
...
*/
    ...
    function get_kode_asset_B_nama()
    {
       $this->db->select('nama_aset');
		$this->db->from('sub_sub_kelompok');
		$this->db->distinct();
	...
	public function simpan_b($data_b)
	{
		
		$query = $this->db->insert("kib_b", $data_b);
    ...
    /*function get_kode_asset_C()
    {
       $this->db->select('nama_aset, kode_aset');
		$this->db->from('sub_sub_kelompok');
		$this->db->distinct();
		$this->db->order_by('kode_aset', 'asc');
		$this->db->where('id_golongan', '03.'); 

		$query = $this->db->get();
		return $query->result();
  
    }*/
    function get_kode_asset_C_nama()
    {
       $this->db->select('nama_aset');
		$this->db->from('sub_sub_kelompok');
		$this->db->distinct();
    ...
    public function simpan_c($data_c)
	{
		
		$query = $this->db->insert("kib_c", $data_c);
    ...
    function get_kode_asset_D_nama()
    {
       $this->db->select('nama_aset');
		$this->db->from('sub_sub_kelompok');
		$this->db->distinct();
		$this->db->order_by('nama_aset', 'asc');
		$this->db->where('id_golongan', '04.'); 
    ...
    public function simpan_d($data_d)
	{
		
		$query = $this->db->insert("kib_d", $data_d);
    ...
    function get_kode_asset_E_nama()
    {
       $this->db->select('nama_aset');
		$this->db->from('sub_sub_kelompok');
		$this->db->distinct();
    ...
    public function simpan_e($data_e)
	{
		
		$query = $this->db->insert("kib_e", $data_e);
	...
	public function simpan_f($data_f)
	{
		
		$query = $this->db->insert("kib_f", $data_f);
	  ...
	  function get_kode_asset_F()
    {
       $this->db->select('nama_aset, kode_aset');
		$this->db->from('sub_sub_kelompok');
		$this->db->distinct();
		$this->db->order_by('kode_aset');
		$this->db->where('id_golongan', '06.'); 

		$query = $this->db->get();
		return $query->result();
  
    }
    function get_kode_asset_F_nama()
    {
       $this->db->select('nama_aset');
		$this->db->from('sub_sub_kelompok');
		$this->db->distinct();
		$this->db->order_by('nama_aset');
		$this->db->where('id_golongan', '06.'); 
...
*/
	...
	function update_pmasukan_kiba($idaset,$namaaset,$kodeaset,$register,$luas,$tahunpengadaan,$alamat,$statustanah,
	...
	function update_pmasukan_kibc($idaset,$namaaset,$kodeaset,$register,$kondisi,$bertingkat,$betontidak,$luaslantai,
	...
	function update_pmasukan_kibd($idaset,$namaaset,$kodeaset,$register,$konstruksi,$panjang,$lebar,$luas,
	...
	function update_pmasukan_kibe($idaset,$namaaset,$kodeaset,$register,$judulbuku,$spesifikasibuku,$tahunpengadaan,
	...
	function update_pmasukan_kibf($idaset,$namaaset,$kodeaset,$bangunan,$bertingkattidak,$betontidak,$luas,$alamat,
