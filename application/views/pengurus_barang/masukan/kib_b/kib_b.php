    ...
    <section class="content-header">
      <h1>
       ...
       <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url().'petugas_inven/kib_b'?>">KIB B</a></li>
      </ol>
    </section>
            ...
            <ul class="nav nav-tabs pull-right">
			  ...
			  <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    <li><a  href="<?php echo base_url()?>petugas_inven/cetak_qrcode_b" target="_blank">Cetak QR CODE</a></li>
                    <li><a  href="<?php echo base_url()?>petugas_inven/pdf_kib_b" target="_blank">Cetak Laporan</a></li>
                  </ul>
              </li>
              <li class="pull-left header"> Peralatan dan Mesin</li>
            </ul>
            <!-- /.box-header -->
            <div class="box-body">
