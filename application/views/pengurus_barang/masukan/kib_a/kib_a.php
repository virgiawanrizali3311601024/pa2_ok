    ...
    <section class="content-header">
      <h1>
       ...
       <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url().'petugas_inven/kib_a'?>">KIB A</a></li>
      </ol>
    </section>
...
<section class="content">
            ...
            <ul class="nav nav-tabs pull-right">
			  ...
			  <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    <li><a  href="<?php echo base_url()?>petugas_inven/cetak_qrcode_a" target="_blank">Cetak QR CODE</a></li>
                    <li><a href="<?php echo base_url()?>petugas_inven/pdf_kib_a" target="_blank">Cetak Laporan</a></li>
                  </ul>
              </li>
              <li class="pull-left header"> Tanah</li>
            </ul>
            <!-- /.box-header -->
               <div class="box-body">
  ...
  <!-- /.content-wrapper -->
<!-- DataTables -->
<script src="<?php echo base_url()?>https://cdnjs.cloudflare.com/ajax/libs/tablefilter/2.5.0/tablefilter.js"></script>
...
$(document).ready(function() {
    $('#datatable').DataTable({
      ...
      "autoWidth": false,
        ...
        "ajax": {
            url : "<?php echo site_url("petugas_inven/Data_kib_a/1") ?>",
            type : 'GET'
        },
