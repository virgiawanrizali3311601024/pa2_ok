    ...
    <section class="content-header">
      <h1>
       ...
       <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url().'petugas_inven/kib_e'?>">KIB E</a></li>
      </ol>
    </section>
            ...
            <ul class="nav nav-tabs pull-right">
			  ...
			  <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    <li><a  href="<?php echo base_url()?>petugas_inven/cetak_qrcode_e" target="_blank">Cetak QR CODE</a></li>
                    <li><a href="<?php echo base_url()?>petugas_inven/pdf_kib_e" target="_blank">Cetak Laporan</a></li>
                  </ul>
              </li>
              <li class="pull-left header">Aset Tetap Lainnya</li>
            </ul>
            <!-- /.box-header -->
            <div class="box-body">
    ...
    $('#datatable').DataTable({
      ...
      columns: [
        { title: "No" },
            ...
            { title: "Nama Barang" },
            { title: "Register" },
            { title: "Judul/Pencipta" },
            { title: "Spesifikasi" },
            { title: "Jumlah" },
            { title: "Tahun Cetak/Pembelian" },
            { title: "Asal Usul" },
            {
              title: "Harga",
      ...
      "autoWidth": false,
        ...
        "ajax": {
            url : "<?php echo site_url("petugas_inven/Data_kib_e/1") ?>",
            type : 'GET'
        },
