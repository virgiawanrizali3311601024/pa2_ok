    ...
    <section class="content-header">
      <h1>
       ...
       <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url().'petugas_inven/kib_f'?>">KIB F</a></li>
      </ol>
    </section>
            ...
            <ul class="nav nav-tabs pull-right">
			  ...
			  <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    <li><a  href="<?php echo base_url()?>petugas_inven/cetak_qrcode_f" target="_blank">Cetak QR CODE</a></li>
                    <li><a href="<?php echo base_url()?>petugas_inven/pdf_kib_f" target="_blank">Cetak Laporan</a></li>
                  </ul>
              </li>
              <li class="pull-left header">Konstruksi Dalam Pengerjaan</li>
            </ul>
            <!-- /.box-header -->
            <div class="box-body">
...
$(document).ready(function() {
    $('#datatable').DataTable({
      ...
      "autoWidth": false,
        ...
        "ajax": {
            url : "<?php echo site_url("petugas_inven/Data_kib_b/1") ?>",
            type : 'GET'
        },
