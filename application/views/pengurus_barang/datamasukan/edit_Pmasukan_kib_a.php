        ...
        <div class="col-xs-13">
          <div class="box">
            ...
            <div class="box-body table-responsive">
                <?php echo form_open('pengurus_barang/edit_pmasukan_kiba'); ?>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-3">
                                ...
                                <input name="tanggal_sertifikat" value="<?php echo $data->tanggal_sertifikat; ?>" placeholder="Tanggal Sertifikat" class="form-control" type="date">
...
$("#kodeaset").select2({
    ...
    ajax:{
        url:"<?php echo site_url('pengurus_barang/list_p_aseta')?>",
        dataType: 'json',
...
{
    $.ajax({
    url:"<?php echo site_url('pengurus_barang/get_info_p_aseta')?>",
        data:{kata : kata},
