  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container">
        <div class="row">
          <div class="col-sm-3"><h4><b>Data Pembukuan KIB A</b></h4>
          </div>
        </div>
      </div>
    </section>
            ...
            <div class="box-header">
              ...
              <div class="col-md-1">
                    <span class="pull-left">
                        <a class="btn btn-default" href="<?php echo base_url().'pengurus_barang/Pmasukan_kiba'?>"><i class="fa fa-arrow-left"> </i> Back</a>
                    </span>
              </div>
            </div>          
