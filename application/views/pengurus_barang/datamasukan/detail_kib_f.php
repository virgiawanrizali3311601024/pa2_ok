  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Detail Data Masukan KIB F
        <small>Konsruksi Dalam Pengerjaan</small>
      </h1>
    </section>  
    <!-- Main content -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-6">
                              ...
                              <div class="col-xs-6">
                                ...
                                <br>
                                <a class="btn btn-sm btn-primary" title="Download"  value="id_aset" href="<?php echo base_url() ?>Pengurus_barang/get_p_imagef/<?php echo $data->id_aset ?>"><i class="glyphicon glyphicon-download-alt"></i> Download</a>
                            ...
                            <div class="col-xs-6">
                                <label>Kontrak</label>
                                <br>
                               <a class="btn btn-sm btn-primary" title="Download"  href="<?php echo base_url() ?>Pengurus_barang/get_p_kontrakf/<?php echo $data->id_aset ?>"><i class="glyphicon glyphicon-download-alt"></i> Download Kontrak</a>
                                <!-- <input name="foto_fisik" placeholder="Foto Fisik" class="form-control" type="text"> -->
