                ...
                <tbody>
                    ...
                    ?>
                      <tr>  
                        ...
                        <td><?php echo $hasil->panjang ?></td>
                        <td><?php echo $hasil->lebar ?></td>
                        ...
                        <td>
                            ...
                            <a href="<?php echo base_url() ?>Pengurus_barang/view_edit_Pmasukan_kibd/<?php echo $hasil->id_aset ?>" class="btn btn-sm btn-success">Edit</a>
                        </td>
                      </tr>
...
function detail_kib_masukan(id_aset)
{
    ...
    $.ajax({
        url : "<?php echo site_url('Pengurus_barang/view_id_masukan_kibd/')?>/"+id_aset,
        type: "GET",
        dataType: "JSON",
