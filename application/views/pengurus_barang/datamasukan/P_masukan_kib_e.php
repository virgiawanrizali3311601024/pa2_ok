                ...
                <tbody>
                    ...
                    ?>
                      <tr>  
                        ...
                        <td>
                             <a href="<?php echo base_url() ?>Pengurus_barang/detail_kibe/<?php echo $hasil->id_aset ?>" class="btn btn-sm btn-success">Detail</a>
                          <!--<a onclick="detail_kib_masukan(<?php echo $hasil->id_aset ?>)" class="btn btn-sm btn-success">Detail</a> -->
                            <a href="<?php echo base_url() ?>Pengurus_barang/view_edit_Pmasukan_kibe/<?php echo $hasil->id_aset ?>" class="btn btn-sm btn-success">Edit</a>
                        </td>
                      </tr>
...
function detail_kib_masukan(id_aset)
{
    ...
    $.ajax({
        url : "<?php echo site_url('Pengurus_barang/view_id_masukan_kibe/')?>/"+id_aset,
        type: "GET",
        dataType: "JSON",
