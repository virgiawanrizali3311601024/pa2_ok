        ...
        <div class="col-xs-13">
          <div class="box">
            <div class="box-header">
              <button class="btn btn-default" onclick="window.location.reload(true)"><i class="glyphicon glyphicon-refresh"></i> Muat Ulang</button>
              </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive">
              ...
              <a href="<?php echo base_url().'pengurus_barang/view_download_kibb'?>" class="btn btn-primary">Konversi Ke Excel</a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('pengurus_barang/view_arsip_kibb')?>",
            "type": "POST",
            "data": function ( data ) {
...
$('#table').on('click', '.item-detail', function(){
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url() ?>pengurus_barang/view_detail_arsip_kibb",
