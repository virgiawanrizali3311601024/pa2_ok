  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <a href="<?php echo base_url().'pengurus_barang/view_download_kibc'?>" class="btn btn-primary">Konversi Ke Excel</a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('pengurus_barang/view_arsip_kibc')?>",
            "type": "POST",
            "data": function ( data ) {
...
$('#table').on('click', '.item-detail', function(){
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url() ?>pengurus_barang/view_detail_arsip_kibc",
