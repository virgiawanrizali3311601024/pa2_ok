          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url()?>kabid/gantipassword" class="btn btn-default btn-flat"><i class="fa fa-cogs"></i> Kata Sandi</a>
                </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'kabid/arsip_kiba'?>"><i class="fa fa-circle-o"></i> KIB A</a></li>
            <li><a href="<?php echo base_url().'kabid/arsip_kibb'?>"><i class="fa fa-circle-o"></i> KIB B</a></li>
            <li><a href="<?php echo base_url().'kabid/arsip_kibc'?>"><i class="fa fa-circle-o"></i> KIB C</a></li>
            <li><a href="<?php echo base_url().'kabid/arsip_kibd'?>"><i class="fa fa-circle-o"></i> KIB D</a></li>
            <li><a href="<?php echo base_url().'kabid/arsip_kibe'?>"><i class="fa fa-circle-o"></i> KIB E</a></li>
