  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="container">
        <a href="<?php echo base_url().'kabid/view_download_kibc'?>" class="btn btn-primary">Konversi Ke Excel</a>
        </div>
      </div>
    </section>
    <!-- /.content -->
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('kabid/view_arsip_kibc')?>",
            "type": "POST",
            "data": function ( data ) {
...
$('#table').on('click', '.item-detail', function(){
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url() ?>kabid/view_detail_arsip_kibc",
