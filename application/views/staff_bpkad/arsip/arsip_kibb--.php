...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('staff_bpkad/view_arsip_kibb')?>",
            "type": "POST",
            "data": function ( data ) {
...
$('#table').on('click', '.item-detail', function(){
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url() ?>staff_bpkad/view_detail_arsip_kibb",
...
function delete_kibb(id_aset)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('staff_bpkad/hapus_arsip_kibb')?>/"+id_aset,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
<div class="modal fade" id="modal_form_edit" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h3 class="modal-title">Edit KIB B Form</h3>
            </div>
