  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="container">
        <a href="<?php echo base_url().'staff_bpkad/export_kibe'?>" class="btn btn-primary">Konversi Ke Excel</a>
        </div>
      </div>
    </section>
    <!-- /.content -->
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('staff_bpkad/view_arsip_kibe')?>",
            "type": "POST",
            "data": function ( data ) {
...
$('#table').on('click', '.item-detail', function(){
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url() ?>staff_bpkad/view_detail_arsip_kibe",
...
function delete_kibe(id_aset)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('staff_bpkad/hapus_arsip_kibe')?>/"+id_aset,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
<div class="modal fade" id="modal_form_edit" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h3 class="modal-title">Edit KIB E Form</h3>
            </div>
            <div class="modal-body form">
                    ...
                    <div class="form-body">
                        <div class="form-group row">
                            ...
                            <div class="col-xs-3">
                                ...
                                <input name="judul_buku" placeholder="Judul Buku" class="form-control" type="text">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-xs-3">
                                <label>Spesifikasi Buku</label>
                                <input name="spesifikasi_buku" placeholder="Spesifikasi Buku" class="form-control" type="text">
                            </div>
                            <div class="col-xs-3">
