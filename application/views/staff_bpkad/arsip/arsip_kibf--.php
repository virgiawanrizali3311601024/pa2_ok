  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="container">
        <a href="<?php echo base_url().'staff_bpkad/export_kibf'?>" class="btn btn-primary">Konversi Ke Excel</a>
        </div>
      </div>
    </section>
    <!-- /.content -->
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('staff_bpkad/view_arsip_kibf')?>",
            "type": "POST",
            "data": function ( data ) {
                data.kode_lokasi = $('#kode_lokasi').val();
                data.nilai_kontrak = $('#nilai_kontrak').val();
...
$('#table').on('click', '.item-detail', function(){
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url() ?>staff_bpkad/view_detail_arsip_kibf",
...
function delete_kibf(id_aset)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('staff_bpkad/hapus_arsip_kibf')?>/"+id_aset,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
<div class="modal fade" id="modal_form_edit" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h3 class="modal-title">Edit KIB F Form</h3>
            </div>
            <div class="modal-body form">
                    ...
                    <div class="form-body">
                        <div class="form-group row">
                            ...
                            <div class="col-xs-3">
                                ...
                                <input name="bangunan" placeholder="Bangunan" class="form-control" type="text">
                            </div>
                            <div class="col-xs-3">
                                <label>Bertingkat / Tidak</label>
                                <input name="bertingkat _tidak" placeholder="Bertingkat / Tidak" class="form-control" type="text">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-xs-3">
                        ...
                        <div class="form-group row">
                            <div class="col-xs-3">
                                ...
                                <input name="nomor_dokumen" placeholder="Nomor Dokumen" class="form-control" type="text">
                            </div>
                            <div class="col-xs-3">
                                <label>Tahun Bulan Mulai</label>
                                <input name="tahun_bulan_mulai" placeholder="Tahun Bulan Mulai" class="form-control" type="text">
                            </div>
                            <div class="col-xs-3">
                            ...
                            <div class="col-xs-3">
                                ...
                                <input name="nilai_kontrak" placeholder="Nilai Kontrak" class="form-control" type="text">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-xs-3">
                            ...
                            <div class="col-xs-3">
                                ...
                                <input name="luas_tanah" placeholder="Luas Tanah" class="form-control" type="text">
                            </div>
                            <div class="col-xs-3">
                                <label>Asal Usul Pembiayaan</label>
                                <input name="asal_usul_pembiayaan" placeholder="Asal Usul Pembiayaan" class="form-control" type="text">
                            </div>
                            <div class="col-xs-3">
                                <label>Status Tanah</label>
                                <input name="status_tanah" placeholder="Status Tanah" class="form-control" type="text">
