              ...
              <table id="table-data" class="table table-bordered table-striped">
                ...
                <?php foreach ($download as $data): ?>
                  <tr>
                      ...
                      <td>
                      <a class="btn btn-sm btn-primary" href="<?php echo base_url().'staff_bpkad/export_kibb/'.$data->kode_lokasi?>" title="Download" ><i class="glyphicon glyphicon-list"></i> Download</a>
                      </td>
                  </tr>
                  <?php endforeach; ?>
                </tbody>
