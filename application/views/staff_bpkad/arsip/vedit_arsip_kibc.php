            ...
            <div class="box-header">
              ...
              <div class="col-md-1">
                    <span class="pull-left">
                        <a class="btn btn-default" href="<?php echo base_url().'staff_bpkad/arsip_kibc'?>"><i class="fa fa-arrow-left"> </i> Back</a>
                    </span>
              </div>
            </div>
            <!-- /.box-header -->
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group row">
                            <div class="col-xs-3">
                                ...
                                <?php echo form_error('bertingkat'); ?>
                            </div>
                            <div class="col-xs-3">
                            ...
                            <div class="col-xs-3">
                                ...
                                <?php echo form_error('luas_lantai'); ?>
                            </div>
                            <div class="col-xs-3">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-3">
                                ...
                                <?php echo form_error('nomor_dokumen_gedung'); ?>
                            </div>
                            <div class="col-xs-3">
...
$("#kodeaset").select2({
	...
	ajax:{
		url:"<?php echo site_url('staff_bpkad/list_asetc')?>",
		dataType: 'json',
...
{
	$.ajax({
	url:"<?php echo site_url('staff_bpkad/get_info_asetc')?>",
		data:{kata : kata},
