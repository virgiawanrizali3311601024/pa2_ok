                    ...
                    ?>
                      <tr>  
                        ...
                        <td>
                            ...
                            <a href="<?php echo base_url() ?>staff_bpkad/detail_s_kibc/<?php echo $hasil->id_aset ?>" class="btn btn-sm btn-success">Detail</a>
                            <a href="<?php echo base_url() ?>staff_bpkad/view_edit_masukan_kibc/<?php echo $hasil->id_aset ?>" class="btn btn-sm btn-success">Edit</a>
                            <a onclick="delete_kibc(<?php echo $hasil->id_aset ?>)" class="btn btn-sm btn-danger">Hapus</a>
                        </td>
                      </tr>
...
function detail_kib_masukan(id_aset)
{
    ...
    $.ajax({
        url : "<?php echo site_url('staff_bpkad/view_id_masukan_kibc/')?>/"+id_aset,
        type: "GET",
        dataType: "JSON",
...
function edit_kibc_masukan(id_aset)
{
...
function save()
{
    ...
    $.ajax({
        url : "<?php echo site_url('staff_bpkad/edit_masukan_kibc')?>",
        type: "POST",
...
function delete_kibc(id_aset)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('staff_bpkad/hapus_masukan_kibc')?>/"+id_aset,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
