                ...
                <tbody>
                    ...
                    ?>
                      <tr>  
                        ...
                        <td><?php echo $hasil->konstruksi?></td>
                        ...
                        <td>
                            <a href="<?php echo base_url() ?>staff_bpkad/status_masukan_kibd/<?php echo $hasil->id_aset ?>" class="btn btn-sm btn-danger">Setujui Aset</a>
                            <a href="<?php echo base_url() ?>staff_bpkad/detail_s_kibd/<?php echo $hasil->id_aset ?>" class="btn btn-sm btn-success">Detail</a>
                            <a href="<?php echo base_url() ?>staff_bpkad/view_edit_masukan_kibd/<?php echo $hasil->id_aset ?>" class="btn btn-sm btn-success">Edit</a>
                            <a onclick="delete_kibd(<?php echo $hasil->id_aset ?>)" class="btn btn-sm btn-danger">Hapus</a>
                        </td>
                      </tr>
...
function detail_kib_masukan(id_aset)
{
    ...
    $.ajax({
        url : "<?php echo site_url('staff_bpkad/view_id_masukan_kibd/')?>/"+id_aset,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="konstruksi"]').val(data.konstruksi);
            ...
            $('.modal-title').text('Detail Kib D'); // Set title to Bootstrap modal title
...
function edit_kibd_masukan(id_aset)
{
...
function save()
{
    ...
    $.ajax({
        url : "<?php echo site_url('staff_bpkad/edit_masukan_kibd')?>",
        type: "POST",
...
function delete_kibd(id_aset)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('staff_bpkad/hapus_masukan_kibd')?>/"+id_aset,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-3">
                             ...
                             <div class="col-xs-3">
                                ...
                                <input name="konstruksi" placeholder="Bertingkat" class="form-control" type="text">
                                
                            </div>
                            <div class="col-xs-3">
                                <label>Panjang</label>
                                <input name="panjang" placeholder="Beton / Tidak" class="form-control" type="text">
                                
                            </div>
                             <div class="col-xs-3">
                                <label>Lebar</label>
                                <input name="lebar" placeholder="Beton / Tidak" class="form-control" type="text">
